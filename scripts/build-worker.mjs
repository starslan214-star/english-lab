...
const bundledBooks=books.replace('export async function getOpenBook','async function getOpenBook');
const bundledHandler=handler.replace("import {getNews} from './news.mjs';",'').replace("import {getDictionaryDefinition,getDatamuseDefinition} from './dictionary.mjs';",'').replace("import {translateBaidu} from './baidu.mjs';",'').replace("import {getOpenBook} from './books.mjs';",'').replace('export function createHandler','function createHandler');
