...
const files=['index.html','fsrs.js','review-core.js','app.js','vocab-data.js','vocab-ui.js','i18n.js','ai.js','news.js','dictionary-ui.js','ai-dictionary.js','datamuse-dictionary.js','notebook.js','settings.js','library.js','adaptive-game.js','version.js','style.css','i18n.css','news.css','vocab.css','dictionary.css','notebook.css','settings.css','library.css','adaptive-game.css','print.css','sw.js','manifest.webmanifest','icon.svg'];
const assets={};
...
const bundledDictionary=dictionary.replace('export async function getDictionaryDefinition','async function getDictionaryDefinition').replace('export async function getDatamuseDefinition','async function getDatamuseDefinition');
const bundledBaidu=baidu.replace('export async function translateBaidu','async function translateBaidu');
const bundledHandler=handler.replace("import {getNews} from './news.mjs';",'').replace("import {getDictionaryDefinition,getDatamuseDefinition} from './dictionary.mjs';",'').replace("import {translateBaidu} from './baidu.mjs';",'').replace('export function createHandler','function createHandler');
